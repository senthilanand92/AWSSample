package main.java.com.amazonaws.samples.manager;
...
import main.java.com.amazonaws.samples.factory.AWSClientFactory;
import main.java.com.amazonaws.samples.models.Employee;

public class AWSManager {
	
	static AWSClientFactory clientFactory= new AWSClientFactory();
	...
	public void loadExample(BasicAWSCredentials basicCred,ClientConfiguration clientCfg) throws IOException{
	    ...
	    public void cleanUp(){
	    	clientFactory.shutDownClientDynamoClient();
	    }
